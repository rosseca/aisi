...
func TestParseVersion(t *testing.T) {
	tests := []struct {
		...
		{"valid with snapshot suffix", "0.4.1-snapshot", 0, 4, 1, false, ""},
		{"valid with v and snapshot", "v1.2.3-snapshot", 1, 2, 3, false, ""},
		{"valid with rc suffix", "1.0.0-rc1", 1, 0, 0, false, ""},
		{"valid with build metadata", "1.2.3+build.123", 1, 2, 3, false, ""},
...
func TestManifest_CheckCLIVersion(t *testing.T) {
	tests := []struct {
		...
		{"snapshot version passes", "1.0.0", "0.4.1-snapshot", false, false},
		{"v prefix snapshot passes", "1.0.0", "v0.4.1-snapshot", false, false},
